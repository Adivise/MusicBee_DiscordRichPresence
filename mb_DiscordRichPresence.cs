...
namespace MusicBeePlugin
{
    public partial class Plugin
    {
        ...
        private void InitialiseDiscord()
        {
            ...
            DiscordRPC.Initialize("727397291509547028", ref handlers, true, null);
        }
        ...
        private void UpdatePresence(string artist, string track, string album, string duration, Boolean playing, string smallImageText = "Playing...")
        {
			...
			if (playing) presence.smallImageKey = "online";
			else presence.smallImageKey = "idle";
                ...
                case NotificationType.PlayStateChanged:
                    switch (mbApiInterface.Player_GetPlayState())
                    {
                        ...
                        case PlayState.Paused:
                            UpdatePresence(artist, trackTitle, album, duration, false, smallImageText: "Paused");
                            break;
                    }
                    break;
